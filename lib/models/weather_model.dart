class WeatherModel {
  ...
  factory WeatherModel.fromJson(Map<String, dynamic> json) {
    return WeatherModel(
      ...
      uvIndex: json['uv']?.toDouble(), // nếu có API UV
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'sys': {
        'country': country,
        'sunrise': sunrise != null ? sunrise!.millisecondsSinceEpoch ~/ 1000 : null,
        'sunset': sunset != null ? sunset!.millisecondsSinceEpoch ~/ 1000 : null,
      },
      'main': {
        'temp': temperature,
